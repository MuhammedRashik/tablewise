...
import {
  ...
  UtensilsCrossed, BarChart3, Settings, LogOut, Menu,
} from "lucide-react";
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
          ...
          {sidebarOpen && (
            <span className="text-sm font-semibold text-gray-900 truncate">TableWise</span>
          )}
          <button onClick={toggleSidebar} className="ml-auto text-gray-400 hover:text-gray-600">
            <Menu size={18} />
          </button>
        </div>
        ...
        <div className="px-2 py-3 border-t border-gray-100">
          <button
            ...
            className={`sidebar-link w-full text-red-500 hover:bg-red-50 ${!sidebarOpen ? "justify-center px-2" : ""}`}
          >
